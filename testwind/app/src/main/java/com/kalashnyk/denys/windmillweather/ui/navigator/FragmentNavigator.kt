package com.kalashnyk.denys.windmillweather.ui.navigator
...
import com.kalashnyk.denys.windmillweather.base.ui.BaseFragment
...
import com.kalashnyk.denys.windmillweather.ui.navigator.model.*
...
class FragmentNavigatorImpl(private val fm: FragmentManager) :
    ...
    fun goToPage(
        ...
        when (page.destination) {
            Pages.CITIES -> handleRoutFragment(CitiesFragment.newInstance(), page, transitionBundle, resultListener)
            Pages.CITY_DETAIL -> handleRoutFragment(CityDetailFragment.newInstance(), page, transitionBundle, resultListener)
            else -> back()
        }
    }
