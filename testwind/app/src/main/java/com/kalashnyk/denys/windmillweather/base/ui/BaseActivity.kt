...
import com.kalashnyk.denys.windmillweather.ui.navigator.Navigator
import com.kalashnyk.denys.windmillweather.ui.navigator.NavigatorImpl
import com.kalashnyk.denys.windmillweather.ui.navigator.model.PageNavigationItem
import com.kalashnyk.denys.windmillweather.ui.navigator.model.Pages
import com.kalashnyk.denys.windmillweather.ui.navigator.model.TransitionAnimation
import com.kalashnyk.denys.windmillweather.ui.navigator.model.TransitionBundle
...
abstract class BaseActivity<V : ViewDataBinding> : AppCompatActivity() {
    ...
    private fun createDaggerDependencies() {
        injectDependency((application as WindmillWeatherApp).getViewModelComponent())
    }
}